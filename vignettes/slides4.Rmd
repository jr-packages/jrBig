...
## The Spark stack
  ...
  * Third party libraries: Like R and Python, developers are encouraged to
  ...
  each of which can be rated by the community. 
...
## Using `dplyr`
  ...
  * The major benefit of using `sparklyr` over `SparkR` is that `dplyr`
...
## Machine learning/Statistcal algorithms
  ...
  * Most, __but not all!__ of this functionality is available within
`sparklyr`. 
